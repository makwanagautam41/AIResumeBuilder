    ...
    <form id="form1" runat="server">
        ...
        <div class="container">
            ...
            <aside class="sidebar" aria-label="Sidebar">
                ...
                <asp:Button ID="NewResumeBtn" runat="server" Text="+ New Resume" CssClass="new-chat-btn" />
                <asp:Button ID="BackToChatBtn" runat="server" Text="💬 Chat Interface" CssClass="new-chat-btn nav-btn" />
