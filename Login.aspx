...
<body class="bg-gray-100 min-h-screen flex items-center justify-center">
    <form id="login" runat="server" class="w-full max-w-md bg-white/90 rounded-xl shadow-lg p-8">
        ...
        <asp:Button ID="ButtonLogin" runat="server" Text="Sign In" CssClass="w-full bg-blue-900 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg transition" OnClick="ButtonLogin_Click" />

        <p class="mt-4 text-center text-gray-700">
            Don't have an account? 
        <a href="Register.aspx" class="text-blue-900 underline">Register</a>
        </p>
    </form>
</body>
</html>
