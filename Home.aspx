<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="airesumebuilder.Home1" %>
...
<asp:Content ID="Content2" runat="server" contentplaceholderid="ContentPlaceHolder1">
                ...
                <head>
                    <meta charset="UTF-8" />
                    <meta name="viewport" content="width=device-width, initial-scale=1.0" /><title>Chat UI</title>
                        ...
                        <div class="main-content">
                            <div class="welcome">
                                ...
                                <div class="example-prompts">
                                    ...
                                    <p>
                                        Give me ideas for a birthday party.</p>
                                </div>
                            </div>
                            <div class="chat-feed">
                                ...
                                <div class="message assistant">
                                    <div class="avatar">
                                        A</div>
                                    <div class="bubble">
                                        I'm good! How can I help you today?</div>
                                </div>
                            </div>
                            <div class="composer">
                                <textarea
                                        ...
                                        aria-label="Message"
                                        disabled>Static chat UI. No input.</textarea>
